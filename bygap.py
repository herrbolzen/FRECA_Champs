...
with open("data.csv") as file:
    ...
    gap2_mult : float = 1.2 # Gap to 2nd placed driver gets a boost
    gap3_mult : float = 1 # Gap to 3rd placed driver stays the same
    ...
    for row in reader: # Assign variables with their values
        ...
        gap2_sc = (gap2 / race_amnt) * gap2_mult
        gap3_sc = (gap3 / race_amnt) * gap3_mult
